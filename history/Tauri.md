...
##  Tauri
  ...
  - V2.9.4
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20251208_Tauri2.9.4_ChromeOS_Flex.png)
  ...
  - V2.9.2
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20251101_Tauri2.9.2_ChromeOS_Flex.png)
  ...
  - V2.9.1
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20251025_Tauri2.9.1_ChromeOS_Flex.png)
    - Android Canary / Pixel 9a / React 19.2.0
      - Java 25導入を試していたことでエラーとなったので、JDK21を有効化してリンク！
        ![On Android Canary](/images/rust/20251025_Tauri2.9.1_Pixel_9a_AndroidCanary.png)
    - iOS 26.0 / iPhone 17 Pro
      ![On iOS 26](/images/rust/20251025_Tauri2.9.1_iPhone17_Pro_iOS26.png)
  - V2.9.0
    - Windows
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20251021_Tauri2.9.0_ChromeOS_Flex.png)
    - Android Canary / Pixel 9a / React 19.2.0
  ...
  - V2.8.5 + Rust 1.90
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250920_Tauri2.8.5_ChromeOS_Flex.png)
  ...
  - V2.8.5 + Rust 1.89
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250904_Tauri2.8.5_ChromeOS_Flex.png)
    - Android 16 QPR2 Beta 1 / Pixel 9a
  ...
  - V2.8.2
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250822_Tauri2.8.2_ChromeOS_Flex.png)
    - Android 16 QPR2 Beta 1 / Pixel 9a
  ...
  - V2.8.1
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250819_Tauri2.8.1_ChromeOS_Flex.png)
    - iOS 26.0 Beta 6 / iPhone 16 Pro
  ...
  - V2.7.0
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250726_Tauri2.7.0_ChromeOS_Flex.png)
  ...
  - V2.6.2
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250628_Tauri2.6.2_ChromeOS_Flex.png)
    - Android 16 / Pixel 9 Pro
  ...
  - V2.6.0
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250626_Tauri2.6.0_ChromeOS_Flex.png)
    - iOS 18.5 / iPhone 16e
  ...
  - V2.5.1
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250429_Tauri2.5.1_ChromeOS_Flex.png)
    - Android 16 / Pixel 9a
  ...
  - V2.5.0
    ...
    - ChromeOS Flex
      ![On ChromeOS Flex](/images/rust/20250417_Tauri2.5.0_ChromeOS_Flex.png)
    - Android 16 / Pixel 9 Pro
  ...
  - V2.4.1
    ...
    - ChromeOS Flex
      - 最初ウィンドウだけでコンテンツが表示されなかった。しかし、Reloadすることで表示された！
        ![On ChromeOS Flex](/images/rust/20250411_Tauri2.4.1_ChromeOS_Flex.png)
    - iOS 18.4 / iPhone 16e
