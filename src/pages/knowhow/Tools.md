...
##  共通 <a id="Common"></a>
### エディタ
- [Visual Studio Code 1.121.0](https://code.visualstudio.com/) <span style="color: red;">*<<2026/05/20 updated from 1.120.0>>*</span>
  ```
...
- [Zed](https://zed.dev)
  ...
  ```
  - Windows
    - [Zed 1.3.5](https://zed.dev/windows) <span style="color: red;">*<<2026/05/21 updated from 1.2.7>>*</span>
      ![On boarding](/images/Zed/20251018_Zed_On_boarding.png)
  - macOS
    - [Zed 1.3.6](https://zed.dev) <span style="color: red;">*<<2026/05/22 updated from 1.3.5>>*</span>
...
- Codex
  ...
  - macOS
    - [Codex 26.519.22136](https://openai.com/ja-JP/codex/)<span style="color: red;">*<<2026/05/22 updated from 26.506.31421>>*</span>
