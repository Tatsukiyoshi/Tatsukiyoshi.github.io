...
##  共通 <a id="Common"></a>
### エディタ
- [Visual Studio Code 1.138.0](https://code.visualstudio.com/) <span style="color: red;">*<<2026/09/17 updated from 1.137.0>>*</span>
  ```
...
- [Zed](https://zed.dev)
  ...
  ```
  - Windows
    - [Zed 1.19.2](https://zed.dev/windows) <span style="color: red;">*<<2026/09/10 updated from 1.18.1>>*</span>
      ![Claude Tasks](/images/ClaudeCode/20260711_Claude_Task_on_Zed.png)
      ![On boarding](/images/Zed/20251018_Zed_On_boarding.png)
  - macOS
    - [Zed 1.20.1](https://zed.dev) <span style="color: red;">*<<2026/09/17 updated from 1.19.2>>*</span>
  - 解消されたバグ
