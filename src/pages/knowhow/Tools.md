...
##  共通 <a id="Common"></a>
### エディタ
- [Visual Studio Code 1.134.0](https://code.visualstudio.com/) <span style="color: red;">*<<2026/08/19 updated from 1.133.0>>*</span>
  ```
...
- [Zed](https://zed.dev)
  ...
  ```
  - Windows
    - [Zed 1.15.1](https://zed.dev/windows) <span style="color: red;">*<<2026/08/19 updated from 1.14.2>>*</span>
