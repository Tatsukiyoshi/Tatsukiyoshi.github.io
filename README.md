...
- [Visual Studio Code 1.90](https://code.visualstudio.com/) <span style="color: red;">*<<2024/06/06 updated from 1.89.1>>*</span>
  - 新機能
    - Ctrl + Clickで複数のタブを選択し、移動することが可能に
      [![Multi Tabs Select](https://github.com/Tatsukiyoshi/Tatsukiyoshi.github.io/assets/48684470/9fbabbb7-193f-44a7-af84-c2bc119b4434)](./captures/20240606_vscode1.90.mp4)
