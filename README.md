...
**毎週日曜日に更新**
  ...
  [最新ダイジェスト（2024/4/1～4/7）](https://note.com/taishow2020/n/n6b658c6cfe75)/
...
## ツール
**OS/言語を問わず利用するツールの情報**
- [Visual Studio Code 1.88](https://code.visualstudio.com/) <span style="color: red;">*<<2024/04/05 updated from 1.87.2>>*</span> <BR />
