...
**毎週日曜日に更新**
  ...
  [最新ダイジェスト：（2024/11/25～12/1）](https://note.com/taishow2020/n/n312b50cfbc72) / [一覧](./digest/digestList.md)
...
## ツール
**OS/言語を問わず利用するツールの情報**
- [Visual Studio Code 1.95.3](https://code.visualstudio.com/) <span style="color: red;">*<<2024/11/15 updated from 1.95.2>>*</span>
