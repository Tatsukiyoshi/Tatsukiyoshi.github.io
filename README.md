...
**毎週日曜日に更新**
  ...
  [最新ダイジェスト（2024/4/22～4/28）](https://note.com/taishow2020/n/n32576806941d)/
...
## ツール
**OS/言語を問わず利用するツールの情報**
- [Visual Studio Code 1.89](https://code.visualstudio.com/) <span style="color: red;">*<<2024/05/04 updated from 1.88.1>>*</span> <BR />
