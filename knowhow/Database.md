...
##  環境
  ...
  |          |- SQL Server Management Studio 21.0.83 Preview 3.0   |[2025/02/11](https://learn.microsoft.com/ja-jp/sql/ssms/ssms-21/release-notes-21?view=sql-server-ver16)
...
### [SQL Server](https://www.microsoft.com/ja-jp/sql-server/sql-server-2022)
  ...
  - SSMS(SQL Server Management Studio)
    ...
    - SQL Server Management Studio 21 <BR />
      ...
      - SSMS 21.0.83 Preview 3.0 <BR />
        ![Update Check](../images/Database/20250211_SSMS21.0.83_Preview3.0.png)
    - SSMS 20.2.3
